...
import sphereAnimation from "../../Hooks/sphereAnimation";
import "./style.scss";
...
class Sphere extends React.Component {
  ...
  componentDidMount() {
    ...
    document.addEventListener("mousemove", (e) => {
      ...
      this.setState({xPos: this.props.data.xPos + ratioX * this.props.data.xPosRatio})
      this.setState({yPos: this.props.data.yPos + ratioY * this.props.data.yPosRatio})
      this.setState({scale: this.props.data.scale + -(ratio * this.props.data.scaleRatio)})
    });
  }
  ...
  render() {
    return (
      <div
        className={`animation-wrapper ${this.props.data.name}`}
        style={{
          transform: `scale(${this.state.scale}) translate(${this.state.xPos}em, ${this.state.yPos}em)`,
        }}
      >
        <div className={`sphere-animation${this.props.data.target}`}>
          <svg
            className="sphere"
            viewBox="0 0 440 440"
